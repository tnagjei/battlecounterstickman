...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-black/70 border-t border-white/10 mt-12">
            {/* Main Footer */}
            <div className="max-w-7xl mx-auto px-4 py-8">
                {/* Internal Navigation */}
                <div className="text-center">
                    <div className="flex justify-center flex-wrap gap-x-4 gap-y-2 text-slate-400 text-sm">
                        <a href="/about" className="hover:text-white transition-colors">{content.footer.about}</a>
                        <span className="text-slate-600">•</span>
                        <a href="/blog" className="hover:text-white transition-colors">{content.footer.blog}</a>
                        <span className="text-slate-600">•</span>
                        <a href="/help" className="hover:text-white transition-colors">{content.footer.help}</a>
                        <span className="text-slate-600">•</span>
                        <a href="#faq" className="hover:text-white transition-colors">{content.footer.faq}</a>
                        <span className="text-slate-600">•</span>
                        <a href={getLocalizedPath("/keywords")} className="hover:text-white transition-colors">{content.footer.topics}</a>
                        <span className="text-slate-600">•</span>
                        <a href="/privacy" className="hover:text-white transition-colors">{content.footer.privacy}</a>
                        <span className="text-slate-600">•</span>
                        <a href="/terms" className="hover:text-white transition-colors">{content.footer.terms}</a>
                    </div>
                </div>

                {/* Partner Links Section */}
                <div className="mt-8 pt-6 border-t border-white/5">
                    <p className="text-center text-slate-600 text-xs uppercase tracking-wider mb-4">Partners & Friends</p>
                    <div className="flex justify-center flex-wrap gap-3 max-w-3xl mx-auto">
                        <a href="https://fast-wan.com/" target="_blank" rel="noopener noreferrer"
                            className="px-3 py-1.5 bg-white/5 rounded-full text-slate-500 text-xs hover:bg-white/10 hover:text-white transition-all">
                            Fast Wan
                        </a>
                ...
                {/* Contact */}
                <div className="mt-6 flex justify-center items-center gap-2 text-slate-500 text-sm">
            ...
            {showPrivacy && (
                <div id="privacy" className="border-t border-slate-800 bg-slate-900/50">
                    <div className="max-w-4xl mx-auto px-4 py-8">
                        ...
                        <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
                            ...
                            <p>My Winter Car Wiki ("we", "our", or "us") respects your privacy. This policy explains how we handle information when you visit our website.</p>
                            <h3 className="text-base font-semibold text-white mt-4">Information We Collect</h3>
                            ...
                            <h3 className="text-base font-semibold text-white mt-4">Cookies</h3>
                            <p>We may use cookies to improve your browsing experience. You can disable cookies in your browser settings at any time.</p>
                            <h3 className="text-base font-semibold text-white mt-4">Third-Party Services</h3>
                            ...
                            <h3 className="text-base font-semibold text-white mt-4">Contact</h3>
            ...
            {showTerms && (
                <div id="terms" className="border-t border-slate-800 bg-slate-900/50">
                    <div className="max-w-4xl mx-auto px-4 py-8">
                        <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
                            <p><strong>Last updated:</strong> December 2025</p>
                            <p>By using My Winter Car Wiki, you agree to the following terms.</p>
                            <h3 className="text-base font-semibold text-white mt-4">Use of Content</h3>
                            ...
                            <h3 className="text-base font-semibold text-white mt-4">User Conduct</h3>
                            <p>Users agree not to misuse the website, attempt to gain unauthorized access, or use the site for any unlawful purpose.</p>
                            <h3 className="text-base font-semibold text-white mt-4">Disclaimer</h3>
                            <p>This wiki is a fan-made resource and is not affiliated with, endorsed by, or connected to the developers of My Winter Car. All game content belongs to their respective owners.</p>
                            <h3 className="text-base font-semibold text-white mt-4">Changes</h3>
